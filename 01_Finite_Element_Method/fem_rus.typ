...
- Синга и немецкого математика, профессора Фрайбургского университета, *Вернера К. Рейнбольдта* (_Werner C. Rheinboldt_, @Rheinboldt_W_C) @Synge_J_L_Rheinboldt_W_C_1957.
...
#figure(
  image("images/Werner_C_Rheinboldt.png", height: 25%),
...
TODO 1:
Эд Уилсон рассказал: «В 1956 году Рэй, Ширли и трое маленьких детей провели год в Норвегии в Научно-исследовательском институте кораблей в Тронхейме. Инженеры института рассчитывали напряжения от вибрации корабля, чтобы спрогнозировать усталостные разрушения при концентрациях напряжений. Именно тогда Рэй понял, что его исследование элементов следует назвать методом конечных элементов, который может решить множество различных типов задач в механике сплошных сред. Рэй понял, что МКЭ является прямым конкурентом метода конечных разностей. В то время FDM использовалось для решения многих задач механики сплошных сред. Его предыдущая работа в Boeing, метод прямой жесткости, использовалась только для расчета перемещений, а не напряжений.

TODO 2:
Distribution theory, which indeed is at the basis of FE theory, was developed by Sergej L. Sobolev in 1936, when he introduced generalized functions to work with weak solutions of PDEs [30]. Later, Laurent Schwartz, in the 1940s, put together a sound theory of distributions [31, 32].
[30] S. L. Sobolev, “Méthode nouvelle à résoudre le problème de Cauchy pour les équations linèaires hyperboliques normales [New method to solve the Cauchy problem for normal hyperbolic linear equations],” Matematicheskii Sbornik - Rec. Math. Moscou (in French), vol. 1, pp. 39-71, 1936.
...
[32] L. Schwartz, Théorie des Distributione [Distribution Theory], Hermann (in French), Paris, F, vol. I, 1950, vol. II, 1951.

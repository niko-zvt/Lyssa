...
#figure(
  ...
  caption: [Питер Дэвид Лакс (1926-наст.вр.).],
) <Lax_P_D>
...
"Независимо от параллельных разработок на Западе, он (Фен) создал теорию МКЭ. Он сыграл важную роль как в реализации метода, так и в создании его теоретической основы с использованием оценок в пространствах Соболева..."
]
